    ...
    createUser(data.email, data.password).then((result) => {
      ...
      updateUserProfile(data.username, data.photoURL)
        .then(() => {
          ...
          Swal.fire({
            title: "Profile",
            text: "User info update successfully",
            icon: "success",
          });
          navigate("/");
        })
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-1 text-sm">
              ...
              <input
                type="url"
                // {...register("username", { required: true })}
                {...register("photoURL", { required: true, minLength: 6 })}
                name="photoURL"
                id="photoURL"
            ...
            <div className="space-y-1 text-sm">
              ...
              <p className="text-red-600">
                Password Must have one uppercase, onelower case and one number and one special character
              </p>
            )} */}

              {errors.password?.type === "minLength" && (
                <p className="text-red-600">
                  Password Must be 6 cheracter or more
                </p>
              )}
